...
np.savez('training_testing_sets.npz', X_train=X_train, X_test=X_test, y_train=y_train, y_test=y_test,vec_citations=vec_citations,vec_validation=vec_validation)
