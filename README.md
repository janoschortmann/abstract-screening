...
### Parameters
When starting the executable, you will arrive on the first step, this is where you will do the querying from the Scopus database.\
<br>
...
<br>
Talking about the API key, the second field will ask you for your API key. **As stated in the _How to use_ section, the API key must support the COMPLETE view**.\
<br>
...
<br>
If every field is entered correctly, you should be able to proceed with the querying, otherwise, an exception will be thrown here or later on.
<p style="text-align: center"><img src="./doc/gifs/params.gif"/></p>
...
<p style="text-align: center"><img src="./doc/images/flow.png"></p>
...
<br>
<br>
<p style="text-align: center"><img src="./doc/gifs/querying.gif"></p>
...
<br>
<br>
<p style="text-align: center"><img src="./doc/gifs/files.gif"></p>
...
<br>
<p style="text-align: center"><img src="./doc/gifs/data.gif"></p>
...
<br>
<br>
<p style="text-align: center"><img src="./doc/gifs/ai.gif"></p>
...
<br>
<br>
<p style="text-align: center"><img src="./doc/gifs/stats.gif"></p>
...
<p style="text-align: center"><img src="./doc/gifs/final.gif"></p>
...
<p style="text-align: center"><img src="./doc/images/papers.png"></p>
